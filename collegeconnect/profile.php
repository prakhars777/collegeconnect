...
$sql = "SELECT username, name, email, gender, branch, semester, city, country, about,  college FROM user";
...
?>
		...
		<div id="header-wrapper">
        	...
        	<div id="header" class="container">
                ...
                <nav id="nav">
                    <ul>                        
                        <li class="current_page_item"><a href="profile.php">My Profile</a></li>
		...
		<div id="box"> 
				...
				<div class="container"  align="center" style="padding-top: 20px">
                            ...
                            <header>
	                            <h3 style="font-size: 3em; font-weight: bold;">My Profile</h3>
                            </header>
							<br><br>
							...
							<br>
                            <a href="maintenance.php" class="button button-style1">Edit Profile</a>
